...
/* Pin definitions */
#define HD44780_RS_LOW              CLEAR_BIT(GPIOB->ODR, GPIO_ODR_OD8)
#define HD44780_RS_HIGH             SET_BIT(GPIOB->ODR, GPIO_ODR_OD8)
#define HD44780_E_LOW               CLEAR_BIT(GPIOB->ODR, GPIO_ODR_OD9)
#define HD44780_E_HIGH              SET_BIT(GPIOB->ODR, GPIO_ODR_OD9)
